...
export function BootstrapGrids() {
  return (
    <div id="wd-bs-grid-system">
      ...
      <Row>
        <Col xs={12} md={6} xl={3} className="bg-warning p-3 mb-3">
          <h3>Column A</h3>
        </Col>
        <Col xs={12} md={6} xl={3} className="bg-primary text-white p-3 mb-3">
          <h3>Column B</h3>
        </Col>
        <Col xs={12} md={6} xl={3} className="bg-danger text-white p-3 mb-3">
          <h3>Column C</h3>
        </Col>
        <Col xs={12} md={6} xl={3} className="bg-success text-white p-3 mb-3">
          <h3>Column D</h3>
        </Col>
      </Row>
    </div>
