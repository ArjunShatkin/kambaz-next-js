...
import { Form, Button, FormLabel, FormControl, FormSelect, FormGroup, FormCheck, InputGroup, Row, Col } from "react-bootstrap";
...
export function BootstrapForms() {
  return (
    <div id="wd-css-styling-forms">
      ...
      <FormControl type="email" placeholder="name@example.com" className="mb-3" />
