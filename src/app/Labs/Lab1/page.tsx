...
My Favorite Recipe
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Marinate chicken in yogurt, lemon juice, and spices for a few hours.</li>
          <li>Grill or sear the chicken until lightly charred and cooked through.</li>
          <li>Simmer onions, garlic, ginger, tomatoes, and cream with spices to make the sauce.</li>
          <li>Add the cooked chicken pieces to the sauce and simmer until flavors blend.</li>
...
<br />
<img id=
"wd-teslabot" src="/images/teslabot.jpg" height="200px" /></div>
...
<br />
<select multiple id="wd-select-many-genre" size={4}>
  <option value="COMEDY">Comedy</option>
  <option value="DRAMA">Drama</option>
  <option value="SCIFI">Science Fiction</option>
  <option value="FANTASY">Fantasy</option>
...
Please
<a href=
"https://www.lipsum.com" id=
"wd-lipsum"> click here </a>
